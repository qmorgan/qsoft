...
def whatis(keyword):
    ...
    helpdict = {
    'A': {'definition':'Alpha: One of the 4 parameters in the Band-function fit to the BAT gamma-ray spectrum.  Alpha is the power-law index *before* the peak in the fit and is typically clustered around -1','type':'double','source':'NatBat Spectra','sample':-0.77270000000000005},
    ...
    'B': {'definition':'Beta: One of the 4 parameters in the Band-function fit to the BAT gamma-ray spectrum.  Beta is the power-law index *after* the peak and has a typical value of around -3 (and is required to be less than -2 for the energy to remain finite)','type':'double','source':'NatBat Spectra','sample':-2.1383000000000001},
    'B1': {'definition':'Beta Lower limit','type':'double','source':'NatBat Spectra','sample':-2.3252999999999999},
    'B2': {'definition':'Beta Upper limit','type':'double','source':'NatBat Spectra','sample':-1.9612000000000001},
    'CHI2': {'definition':'Chi-squared residuals for the fit to the BAT gamma-ray spectrum','type':'double','source':'NatBat Spectra','sample':36.090000000000003},
    'CHI2_PC': {'definition':'Chi-squared residuals for the XRT Spectral Fit using PC (Photon-counting Mode) data - see T_PC for time range','type':'string','source':'NatXRT','sample':'31.90/44'},
    'CHI2_PC_LATE': {'definition':'XRT Spectral Fit Chi-squared residuals from Late Time (>10ks) XRT PC (Photon Counting Mode) Data - see T_PC_LATE for time range','type':'string','source':'NatXRT','sample':'17.49/17'},
    'CHI2_WT': {'definition':'XRT Spectral Fit Chi-squared residuals from WT (Windowed Timing Mode) XRT Data - Typically the earliest data; see T_WT for time range','type':'string','source':'NatXRT','sample':'17.85/20'},
    ...
    'EISO': {'definition':'Bayes Isotropic equivalent Energy [erg]  from integrated BAT Gamma-ray light curve - USES REDSHIFT. (Approximate Bolometric Fluence [erg/cm^2] in the 1-10^4 keV band if no Redshift)','type':'double','source':'NatBat Spectra','sample':6.9099999999999996e+52},
    ...
    'EP': {'definition':'Bayes E_peak: One of the 4 parameters in the Band-function fit to the BAT gamma-ray spectrum.  E_Peak is the energy (frequency) at which most of the energy is emitted.','type':'double','source':'NatBat Spectra - found with a model fit to the spectrum, using bayesian techniques. More trustworthy than EP0.','sample':161.47},
    'EP0': {'definition':'E_peak: One of the 4 parameters in the Band-function fit to the BAT gamma-ray spectrum.  E_Peak is the energy (frequency) at which most of the energy is emitted.','type':'double','source':'NatBat Spectra - found with a model fit to the spectrum, using frequentist techniques. Less trustworthy than EP.','sample':145.96340000000001},
    ...
    'FL': {'definition':'Energy Fluence (15-350 keV) [erg/cm^2] - mathematically, the integral of the BAT gamma-ray light curve over time','type':'double','source':'NatBat Spectra','sample':4.1281000000000003e-06},
    ...
    'FLX_PC': {'definition':'Average Flux from XRT PC Data (mJy @ 1 keV) using XRT PC (Photon-counting Mode) data - see T_PC for time range','type':'double','source':'NatXRT','sample':6.1600000000000007e-05},
    ...
    'FLX_PC_LATE': {'definition':'Average Flux from Late Time (>10ks) XRT PC (Photon Counting Mode) Data (mJy @ 1 keV) - see T_PC_LATE for time range','type':'double','source':'NatXRT','sample':8.8419999999999994e-06},
    ...
    'FLX_WT': {'definition':'Average Flux (mJy @ 1 keV) from XRT WT Data (Windowed Timing Mode) - Typically the earliest data; see T_WT for time range','type':'double','source':'NatXRT','sample':0.0060889999999999998},
    ...
    'GAM_PC': {'definition':'Gamma inferred from XRT PC (Photon-counting Mode) data - see T_PC for time range','type':'double','source':'NatXRT','sample':1.8776999999999999},
    ...
    'GAM_PC_LATE': {'definition':'Gamma inferred from late time (>10ks) XRT PC (Photon Counting Mode) Data - see T_PC_LATE for time range','type':'double','source':'NatXRT','sample':1.9380999999999999},
    ...
    'GAM_WT': {'definition':'Gamma inferred from XRT WT Data (Windowed Timing Mode) - Typically the earliest data; see T_WT for time range','type':'double','source':'NatXRT','sample':2.3073999999999999},
    ...
    'NH_PC': {'definition':'Excess N_H Column inferred from XRT PC Data (10^22 cm^-2) using PC (Photon-counting Mode) data - see T_PC for time range','type':'double','source':'NatXRT','sample':0.017999999999999999},
    ...
    'NH_PC_LATE': {'definition':'Excess N_H Column inferred from late time (>10ks) XRT PC (Photon Counting Mode) Data (10^22 cm^-2) - see T_PC_LATE for time range','type':'double','source':'NatXRT','sample':0.057000000000000002},
    ...
    'NH_WT': {'definition':'Excess N_H Column (10^22 cm^-2) inferred from XRT WT Data (Windowed Timing Mode) - Typically the earliest data; see T_WT for time range','type':'double','source':'NatXRT Spectra','sample':0.052999999999999999},
    ...
    'NISO': {'definition':'Isotropic equivalent Photons [ph] from integrated BAT Gamma-ray light curve - USES REDSHIFT.  (approximate bolometric photon fluence [ph/cm^-2] in observer frame 1-10^4 keV band if no redshift)','type':'double','source':'NatBat','sample':3.4699999999999998e+59},
    'NISO1': {'definition':'NISO lower limit','type':'double','source':'NatBat','sample':2.61e+59},
    'NISO2': {'definition':'NISO upper limit','type':'double','source':'NatBat','sample':5.0600000000000004e+59},
    'NU': {'definition':'BAT Spectral Fit Degrees Of Freedom','type':'double','source':'NatBat Spectra','sample':54.0},
    ...
    'RT45': {'definition':'BAT rT0.45 (Defined in Reichart et al. 2001) - yet another way of defining the duration of the initial burst of gamma-rays','type':'double','source':'NatBat Timing','sample':5.2800000000000002},
    ...
    'T50': {'definition':'BAT T50 Difference between 75th and 25th percentile time of total counts above background level relative to start of burst interval','type':'double','source':'NatBat Timing','sample':7.2599999999999998},
    'T90': {'definition':'BAT T90 Difference between 95th and 5th percentile time of total counts above background level relative to start of burst interval - loosely consistant with Swift T90; Highly dependent on burst start & stop times','type':'double','source':'NatBat Timing','sample':18.48},
    ...
    'fluence': {'definition':'BAT fluence (15-150 keV) [10^-7 erg/cm^2] (see FL for full definition) - trust less than FL?','type':'double','source':'SwiftCat','sample':28.0},
    ...
    'peakflux': {'definition':'1-second integrated peak photon flux of the BAT spectrum (15-150 keV) [ph/cm^2/s]','type':'double','source':'SwiftCat','sample':3.0299999999999998},
    ...
    't90': {'definition':'Swift t90 value, parsed from t90_str (see T90 for full definition)','type':'double','source':'SwiftCat','sample':19.300000000000001},
    ...
    'v_mag_isupper': {'definition':'Is the UVOT V Magnitude an upper limit? - V is our second best chance of getting a detection; typically second on-sky (sometimes first) and the reddest of the filters','type':'string','source':'SwiftCat','sample':'no'},
    ...
    'wh_mag_isupper': {'definition':'Is the UVOT White Magnitude an upper limit? - White mode is our best chance of getting a detection, typically first on-sky (but not always taken, particularly in earlier observations), and widest filter','type':'string','source':'SwiftCat','sample':'no'},
