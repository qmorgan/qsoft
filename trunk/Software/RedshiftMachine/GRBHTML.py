...
class GRBHTML:
    ...
    def add_position_info(self,bat_pos=(123.45,54.32,30),xrt_pos=None,uvot_pos=None,reg_path=None):
        ...
        if xrt_pos != None:
            self.html_block += '''
            <b>XRT</b>: RA = %s, Dec = %s, Uncertainty: %s"<p>
...
def test():
    inst = GRBHTML(123456,'/Users/amorgan/Public/TestDir')
    inst.add_position_info(bat_pos=(123.45,32.52,22),xrt_pos=(123.452,32.622,2.5),reg_path='/Users/amorgan/Desktop/123456.reg')
