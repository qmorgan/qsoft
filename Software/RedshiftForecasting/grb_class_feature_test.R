...
pdf('performance_vs_useless_features_7.pdf')
linear.fit = lm(result ~ useless)
plot(useless,result,ylim=c(0,max(max(result),13/15)),xlab="Number of Useless Features",ylab="Fraction of Highs Classified as High",main="RF Performance vs. Number of Useless Features: Weight 5 on High")
